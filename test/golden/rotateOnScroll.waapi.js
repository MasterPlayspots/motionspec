...
/* Spec: rotateOnScroll  Lowering: web-animations-api (no GSAP) */
(function () {
  ...
  /* card-rotate (rotateOnScroll -> scroll + requestAnimationFrame, no GSAP) */
  /* rotate 0deg -> 20deg across the scroll transit */
  (function () {
    ...
    function update() {
      ...
      for (var k = 0; k < els.length; k++) {
        ...
        var p = st.cur;
        els[k].style.transform = 'rotate(' + (p * 20) + 'deg)';
      }
