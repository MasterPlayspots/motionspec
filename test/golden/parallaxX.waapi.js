...
/* Spec: parallaxX  Lowering: web-animations-api (no GSAP) */
(function () {
  ...
  /* layer-x (parallaxX -> scroll + requestAnimationFrame, no GSAP) */
  /* depth offset: translateX 0% -> -30% across the scroll transit */
  (function () {
    var els = document.querySelectorAll(".layer");
    ...
    function update() {
      ...
      for (var k = 0; k < els.length; k++) {
        ...
        var p = st.cur;
        els[k].style.transform = 'translateX(' + (p * -30) + '%)';
      }
