...
/* Spec: parallaxLayer  Lowering: web-animations-api (no GSAP) */
(function () {
  ...
  /* bg-layer (parallaxLayer -> scroll + requestAnimationFrame, no GSAP) */
  /* depth offset: translateY 0% -> -20% across the scroll transit */
  (function () {
    ...
    function update() {
      ...
      for (var k = 0; k < els.length; k++) {
        ...
        var p = st.cur;
        els[k].style.transform = 'translateY(' + (p * -20) + '%)';
      }
