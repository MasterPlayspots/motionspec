...
/* Spec: fadeOnScroll  Lowering: web-animations-api (no GSAP) */
(function () {
  ...
  /* hero-fade (fadeOnScroll -> scroll + requestAnimationFrame, no GSAP) */
  /* opacity 1 -> 0.15 across the scroll transit */
  (function () {
    ...
    function update() {
      ...
      for (var k = 0; k < els.length; k++) {
        ...
        var p = st.cur;
        els[k].style.opacity = (1 + p * (0.15 - 1));
      }
